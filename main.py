...
class Handler(BaseHTTPServer.BaseHTTPRequestHandler):
	...
	def do_POST(self):
		...
		if 'name' in content:
			...
			resp = self.db.icse.processed.find(
				{"school": content['school'][0].upper()}).sort("name")
		else:
...
Handler.db = pymongo.MongoClient(
	'mongodb://xrisk:{}@ds049631.mongolab.com:49631/icse'
	.format(os.environ['MONGO']))
